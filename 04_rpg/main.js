...
const gridLength = 80; // const常數，不會更動
// 網頁載入完成後初始化動作
$(function () {
   ...
   imgMain = new Image();
   imgMain.src = "04_rpg/images/spriteSheet.png";
   currentImgMain = {
      "x": 0,
      "y": 0
   };
   ...
   var sources = {
      mountain: '04_rpg/images/material.png',
      enemy: '04_rpg/images/Enemy.png'
   };
...
$(document).on("keydown", function (event) {
   ...
   // 確認目標位置不會超過地圖
   if (targetImg.x <= gridLength*(mapArray.length-1) && targetImg.x >= 0 && targetImg.y <= gridLength*(mapArray[0].length-1) && targetImg.y >= 0) {
